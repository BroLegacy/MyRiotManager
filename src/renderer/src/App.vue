  ...
  <div class="app-container" :class="{ 'reorder-active': isReorderMode }">
    ...
    <div v-if="!riotPath" class="setup-overlay">
      <div class="setup-box">
        ...
        <p>Pour commencer, veuillez localiser l'exécutable <strong>RiotClientServices.exe</strong> sur votre ordinateur.</p>
    ...
    <header class="app-header">
      ...
      <div class="header-actions">
        ...
        <button v-if="isReorderMode" @click="toggleReorderMode" class="btn btn-primary" title="Valider le nouvel ordre">
    ...
    <div class="main-wrapper">
      <main class="content-area">
        ...
        <draggable v-else v-model="accounts" class="accounts-grid" item-key="id" :disabled="!isReorderMode" @end="onDragEnd" ghost-class="ghost" drag-class="dragging">
          <template #item="{ element: acc }">
            <div class="account-card" :class="{ 'is-loading': isLoading && launchingAccountId === acc.id, 'is-draggable': isReorderMode }">
              <div class="card-header">
                ...
                <div class="card-actions">
                  ...
                  <button @click="openDeleteModal(acc)" class="btn-card-action btn-delete" title="Supprimer le compte">
